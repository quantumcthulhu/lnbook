...
* **Комп’ютери Загального Призначення**: ноду Lightning Network можна запустити на домашньому комп’ютері чи ноутбуці під управлінням Windows, Mac OS або Linux. Зазвичай вона запускається разом з Біткоїн-нодою.
